<?php  //[STAMP] 96661ba358af50314c22562652534c5a
// phpcs:ignoreFile
namespace Tweakwise\Test\Support\_generated;
...
trait FunctionalTesterActions
{
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getObjectManager()
     */
    public function getObjectManager(?string $storeCode = NULL, ?string $area = NULL): \Hipex\Magento2Psr7Bridge\Magento\Framework\App\ObjectManagerInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getObjectManager', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::grabService()
     */
    public function grabService(string $name): mixed {
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::amOnStoreBasedOnUrl()
     */
    public function amOnStoreBasedOnUrl(?string $url = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnStoreBasedOnUrl', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::amOnStore()
     */
    public function amOnStore(string $storeCode, string $area = \Magento\Framework\App\Area::AREA_FRONTEND): void {
        $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnStore', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getCurrentStore()
     */
    public function getCurrentStore(): ?string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentStore', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getCurrentStoreId()
     */
    public function getCurrentStoreId(): ?int {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentStoreId', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getCurrentWebsiteId()
     */
    public function getCurrentWebsiteId(): ?int {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentWebsiteId', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getCurrentArea()
     */
    public function getCurrentArea(): ?string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentArea', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getPlaceholderImage()
     */
    public function getPlaceholderImage(string $type): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPlaceholderImage', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::setAuthToken()
     */
    public function setAuthToken(?string $token = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setAuthToken', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getAuthToken()
     */
     ...
     * @see \Emico\CodeCept\Module\Magento2::sendRestApi()
     */
    public function sendRestApi(string $method, string $path, $data = NULL, array $queryParams = []): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRestApi', func_get_args()));
    }
     ...
     * @throws ExternalUrlException
     * @throws InvalidResponseException
     * @see \Emico\CodeCept\Module\Magento2::sendRestApiPost()
     */
    public function sendRestApiPost(string $path, mixed $data): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRestApiPost', func_get_args()));
    }
     ...
     * @throws ExternalUrlException
     * @throws InvalidResponseException
     * @see \Emico\CodeCept\Module\Magento2::sendRestApiGet()
     */
    public function sendRestApiGet(string $path, array $queryParams = []): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRestApiGet', func_get_args()));
    }
     ...
     * @throws ExternalUrlException
     * @throws InvalidResponseException
     * @see \Emico\CodeCept\Module\Magento2::sendRestApiPut()
     */
    public function sendRestApiPut(string $path, $data): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRestApiPut', func_get_args()));
    }
     ...
     * @throws ExternalUrlException
     * @throws InvalidResponseException
     * @see \Emico\CodeCept\Module\Magento2::sendRestApiDelete()
     */
    public function sendRestApiDelete(string $path): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRestApiDelete', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getLastClientResponse()
     */
    public function getLastClientResponse(): ?\Symfony\Component\BrowserKit\Response {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getLastClientResponse', func_get_args()));
    }
     ...
     * @see \Emico\CodeCept\Module\Magento2::clearCache()
     */
    public function clearCache(array|string|null $types = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearCache', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::clearCacheByTags()
     */
    public function clearCacheByTags(array $tags = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearCacheByTags', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::runInStore()
     */
    public function runInStore(callable $callback, string $storeCode = "admin", string $area = \Magento\Framework\App\Area::AREA_ADMINHTML): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runInStore', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::executeSql()
     */
    public function executeSql(callable|string $callbackOrSql): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('executeSql', func_get_args()));
    }
     ...
     * @see \Emico\CodeCept\Module\Magento2::sendRequest()
     */
    public function sendRequest(string $method, string $uri, $body, array $headers = [], array $parameters = []): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendRequest', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::addConnectorInitializer()
     */
    public function addConnectorInitializer(callable $callback): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('addConnectorInitializer', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::forEachConnector()
     */
    public function forEachConnector(callable $callback): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('forEachConnector', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::getClient()
     */
    public function getClient(): \Symfony\Component\BrowserKit\AbstractBrowser {
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::isMagentoModuleEnabled()
     */
    public function isMagentoModuleEnabled(string $moduleName): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('isMagentoModuleEnabled', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::shouldUseRealAmqp()
     */
    public function shouldUseRealAmqp(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('shouldUseRealAmqp', func_get_args()));
    }
     ...
     *
     *
     * @see \Emico\CodeCept\Module\Magento2::shouldUseDatabaseIsolation()
     */
    public function shouldUseDatabaseIsolation(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('shouldUseDatabaseIsolation', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Replaces a class within the ObjectManager Factory with a mockery mock
     * !!Mockery mocks should be created by using the FQN. Type hinting will break if you don't!!
     *
     * @template MockClass of object
     * @param class-string<MockClass>          $type
     * @param \Mockery\MockInterface&MockClass $mock
     * @see \Emico\CodeCept\Module\Mocking::mockService()
     */
    public function mockService(string $type, \Mockery\MockInterface $mock): void {
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Create a partial mockery mock, which allows you to stub certain methods but keep the rest of the object logic
     * original It will take care of injecting all constructor dependencies using Magento di factories.
     *
     * @template MockClass of object
     * @param class-string<MockClass> $type
     * @param array                   $arguments Uses di.xml arguments or autowire by default, but allows to change
     *                                           certain arguments on creation.
     *
     * @return \Mockery\MockInterface&MockClass
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Mocking::createPartialMock()
     */
    public function createPartialMock(string $type, array $arguments = []): \Mockery\MockInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createPartialMock', func_get_args()));
    }
     ...
     * @param class-string $preference
     * @see \Emico\CodeCept\Module\Mocking::setPreferenceForType()
     */
    public function setPreferenceForType(string $type, string $preference): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setPreferenceForType', func_get_args()));
    }
     ...
     *
     * @param int $timestamp
     * @see \Emico\CodeCept\Module\Mocking::mockDate()
     */
    public function mockDate(int $timestamp): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockDate', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Cleans up all or `FixtureInterface::deleteAfterTest() == true` fixtures
     *
     * @param bool $all
     *
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::cleanUp()
     */
    public function cleanUp(bool $all = false): void {
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @param \Emico\CodeCept\Models\Fixtures\CartFixture $fixture
     *
     * @return \Emico\CodeCept\Models\Fixtures\CartFixture
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::updateShippingAddress()
     */
    public function updateShippingAddress(\Emico\CodeCept\Models\Fixtures\CartFixture $fixture): \Emico\CodeCept\Models\Fixtures\CartFixture {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('updateShippingAddress', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @template Fixture of \Emico\CodeCept\Models\Fixtures\FixtureInterface
     ...
     * @return Fixture
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::createFixture()
     */
    public function createFixture(\Emico\CodeCept\Models\Fixtures\FixtureInterface $fixture, string $storeCode = "admin", string $area = \Magento\Framework\App\Area::AREA_GLOBAL): \Emico\CodeCept\Models\Fixtures\FixtureInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createFixture', func_get_args()));
    }
     ...
     * @return Fixture[]
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::createFixtures()
     */
    public function createFixtures(array $fixtures, string $storeCode = "admin"): array {
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Create or fetches an existing category fixture. This category should only be used for simple testing but never
     * altered so they can be reused over different tests to increase performance.
     *
     * @return \Emico\CodeCept\Models\Fixtures\CategoryFixture
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::getGlobalCategoryFixture()
     */
    public function getGlobalCategoryFixture(): \Emico\CodeCept\Models\Fixtures\CategoryFixture {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getGlobalCategoryFixture', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Creates or fetches an existing configurable product fixture. This product should only be used for simple testing
     * but never altered so they can be reused over different test to increase performance.
     *
     * @return \Emico\CodeCept\Models\Fixtures\ConfigurableProductFixture
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::getGlobalConfigurableProductFixture()
     */
    public function getGlobalConfigurableProductFixture(): \Emico\CodeCept\Models\Fixtures\ConfigurableProductFixture {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getGlobalConfigurableProductFixture', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Creates or fetches an existing configurable product fixture. These products should only be used for simple
     * testing but never altered so they can be reused over different test to increase performance.
     *
     * @param int $count number of products to create
     *
     * @return \Emico\CodeCept\Models\Fixtures\ConfigurableProductFixture[]
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::getGlobalConfigurableProductFixtures()
     */
    public function getGlobalConfigurableProductFixtures(int $count = 1): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getGlobalConfigurableProductFixtures', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Will create a random named image in directory in media folder
     *
     ...
     * @see \Emico\CodeCept\Module\Fixtures::getMediaImageFilePath()
     */
    public function getMediaImageFilePath(string $directory, int $width = 1024, int $height = 1024, ?string $fileName = NULL, ?int $mtime = NULL): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getMediaImageFilePath', func_get_args()));
    }
     ...
     *
     * @throws \Magento\Framework\Exception\FileSystemException
     * @see \Emico\CodeCept\Module\Fixtures::clearMediaImageFilePath()
     */
    public function clearMediaImageFilePath(string $directory): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearMediaImageFilePath', func_get_args()));
    }
     ...
     *
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::deleteAll()
     */
    public function deleteAll(string $fixtureType): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('deleteAll', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @param \Emico\CodeCept\Models\Fixtures\FixtureInterface $fixture
     *
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::delete()
     */
    public function delete(\Emico\CodeCept\Models\Fixtures\FixtureInterface $fixture): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('delete', func_get_args()));
    }
     ...
     * @see \Emico\CodeCept\Module\Fixtures::updateAttributeValue()
     */
    public function updateAttributeValue(string $entityType, string $attributeCode, callable $updateCallback): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('updateAttributeValue', func_get_args()));
    }
     ...
     * @throws \Exception
     * @see \Emico\CodeCept\Module\Fixtures::setStock()
     */
    public function setStock(string $sku, float $qty, ?int $status = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setStock', func_get_args()));
    }
     ...
     * @see \Emico\CodeCept\Module\Config::mockConfig()
     */
    public function mockConfig(string $path, $value, ?string $storeCode = NULL, ?string $scopeCode = \Magento\Store\Model\ScopeInterface::SCOPE_STORES): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockConfig', func_get_args()));
    }
     ...
     * @param bool     $assertMessageAck
     * @param bool     $ignoreRejectExceptions
     * @param bool     $bulk
     *
     * @throws LocalizedException
     * @see \Emico\CodeCept\Module\Queue::runConsumer()
     */
    public function runConsumer(string $consumer, ?int $maxMessages = NULL, bool $assertMessageAck = true, bool $ignoreRejectExceptions = false, bool $bulk = false): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('runConsumer', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Runs all consumers that have messages in their queues.
     *
     * @param int|null $maxMessages            The maximum number of messages to process per consumer. If NULL,
     *                                         defaults to 1000 when using real AMQP.
     * @param bool     $assertMessageAck       Whether to assert that messages are acknowledged. Defaults to TRUE.
     * @param bool     $ignoreRejectExceptions Whether to ignore exceptions when messages are rejected. Defaults to
     *                                         FALSE.
     * @param bool     $bulk                   Whether to use the bulk exchange repository. Defaults to FALSE.
     * @param bool     $runUntilEmpty          Whether to continue running consumers until all queues are empty.
     *                                         Defaults to TRUE.
     *
     * @return void
     * @throws LocalizedException If an error occurs while running the consumers.
     * @see \Emico\CodeCept\Module\Queue::runAllConsumersWithMessages()
     */
    public function runAllConsumersWithMessages(?int $maxMessages = NULL, bool $assertMessageAck = true, bool $ignoreRejectExceptions = false, bool $bulk = false, bool $runUntilEmpty = true): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('runAllConsumersWithMessages', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks if any queue in the exchanges contains messages.
     *
     * Iterates through all exchanges and their queues to determine if messages exist.
     *
     * @param bool $bulk Whether to retrieve the bulk exchange repository.
     *
     * @return bool TRUE if a queue has messages, FALSE otherwise.
     * @see \Emico\CodeCept\Module\Queue::hasMessages()
     */
    public function hasMessages(bool $bulk = false): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('hasMessages', func_get_args()));
    }
     ...
     * @param bool        $bulk
     * @see \Emico\CodeCept\Module\Queue::clearQueueTopic()
     */
    public function clearQueueTopic(?string $topic = NULL, bool $bulk = false): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearQueueTopic', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \Emico\CodeCept\Module\Queue::publishMessage()
     */
    public function publishMessage(string $topic, mixed $message): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('publishMessage', func_get_args()));
    }
     ...
     * @throws LocalizedException
     * @see \Emico\CodeCept\Module\Queue::getConsumer()
     */
    public function getConsumer(string $consumer, ?int $maxMessages = NULL): \Magento\Framework\MessageQueue\ConsumerInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getConsumer', func_get_args()));
    }
     ...
     * @return void
     * @throws LocalizedException
     * @see \Emico\CodeCept\Module\Queue::publishMessageWithoutEncoding()
     */
    public function publishMessageWithoutEncoding(string $topic, array $data): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('publishMessageWithoutEncoding', func_get_args()));
    }
}
